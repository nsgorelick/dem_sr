...
class CoreModulesTests(unittest.TestCase):
    ...
    def test_experiment_registry_baseline(self) -> None:
        ...
        frequency = create_experiment("frequency_domain")
        self.assertEqual(frequency.name, "frequency_domain")
        hydrology = create_experiment("hydrology")
        self.assertEqual(hydrology.name, "hydrology")
        mixture = create_experiment("mixture_specialists")
        self.assertEqual(mixture.name, "mixture_specialists")
